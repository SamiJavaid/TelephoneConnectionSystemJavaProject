 ...
 * @author Mohsin Saeed
 */
public class LandlineRecordByEmployee extends javax.swing.JFrame {

        PreparedStatement pst;
        ResultSet rs;
    
    public LandlineRecordByEmployee() {
        initComponents();
        ExCon.call();
        cl();
    }
    ...
    private void initComponents() {
        ...
        jLabel13.setText("Landline Customers Record");
        jPanel6.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 10, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LandlineRecord.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new LandlineRecordByEmployee().setVisible(true);
            }
        });
    }
