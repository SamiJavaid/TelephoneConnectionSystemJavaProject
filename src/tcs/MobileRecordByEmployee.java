 ...
 * @author Mohsin Saeed
 */
public class MobileRecordByEmployee extends javax.swing.JFrame {

   PreparedStatement pst;
   ResultSet rs;
    
    public MobileRecordByEmployee() {
        initComponents();
        ExCon.call();
        cl();
    }
    ...
    private void initComponents() {
        ...
        jLabel13.setText("Mobile Customers Record");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MobileRecord.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new MobileRecordByEmployee().setVisible(true);
            }
        });
    }
